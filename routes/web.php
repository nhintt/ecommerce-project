...
Route::post('/update-delivery/{fee_id}','DeliveryController@update_delivery');
Route::get('/delete-feeship/{fee_id}','DeliveryController@delete_feeship');
Route::get('/select-feeship','DeliveryController@select_feeship');
Route::get('/edit-delivery/{fee_id}','DeliveryController@edit_delivery');
